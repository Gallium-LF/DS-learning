...
int main(){
    ...
    edges[1] = new Edge<int>{1,3};
    edges[2] = new Edge<int>{1,4};
    edges[3] = new Edge<int>{3,4};
    edges[4] = new Edge<int>{5,8};
    edges[5] = new Edge<int>{5,9};
    edges[6] = new Edge<int>{6,8};
    edges[7] = new Edge<int>{9,6};
    AMGraph<int> amg1(ver,9,edges,8);
    cout << "Graph 1: " << endl;
    amg1.printGraph();
    cout << "Adjacency Matrix:" << endl;
    printMatrix(amg1.getMatrix(),9);
